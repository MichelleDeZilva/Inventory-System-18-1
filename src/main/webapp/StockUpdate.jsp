        ...
        <div class="row my-row6">
                ...
                <div class="col-sm-10  my-col3 ">
                    ...
                    <table>
	                 <thead>
	                 	<tr>
	                    	<th><h1 style="margin-right: 450px">Update Stock Item Information</h1></th>
	                    	<th >
		                    	<form action="stockInsert" method="post">
		                    		<input type="hidden"  name="ID" value="kumari" >
                   ...
                   <%
                    ...
                    <table class="table">
                        <tr>
                            <td>
								<form style="text-align:center" action="stockInsert" method="post" name="myForm" >
									...
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control"  id="input2"name="Sellprice" value="<%=list.get(5)%>">
									</div>
									...
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control"  id="input2"name="Amount" value="<%=list.get(6)%>">
									</div>
									<div class="input-group mb-3">
									    <div class="input-group-prepend">
									    ...
									    <select class="form-control" id="sel1"name="Type" >
									    	<option value="<%=list.get(7)%>"><%=list.get(7)%></option> 
                    ...
                    <form align="center" action="ViewAction" method="post">
                    	<button type="View" class="btn" id="createbutton" name="st" Value="Stock">Stock</button>
